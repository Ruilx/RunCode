...
QT_MOC_LITERAL(1, 10, 13), // "openFailedSig"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12), // "writeFileLog"
QT_MOC_LITERAL(4, 38, 9), // "InfoLevel"
QT_MOC_LITERAL(5, 48, 5), // "level"
QT_MOC_LITERAL(6, 54, 9), // "valueName"
QT_MOC_LITERAL(7, 64, 3) // "msg"

    },
    "LogSystem\0openFailedSig\0\0writeFileLog\0"
    "InfoLevel\0level\0valueName\0msg"
};
...
void LogSystem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openFailedSig(); break;
        case 1: _t->writeFileLog((*reinterpret_cast< InfoLevel(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (LogSystem::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogSystem::openFailedSig)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LogSystem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LogSystem.data,
      qt_meta_data_LogSystem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
