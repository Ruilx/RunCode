...
QT_MOC_LITERAL(1, 12, 13), // "requestToExit"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5), // "start"
QT_MOC_LITERAL(4, 33, 6), // "finish"
QT_MOC_LITERAL(5, 40, 4), // "puts"
QT_MOC_LITERAL(6, 45, 6) // "string"

    },
    "InputHandle\0requestToExit\0\0start\0"
    "finish\0puts\0string"
};
...
void InputHandle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestToExit(); break;
        case 1: _t->start(); break;
        case 2: _t->finish(); break;
        case 3: _t->puts((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputHandle::requestToExit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputHandle::requestToExit()
{
