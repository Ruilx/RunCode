...
QT_MOC_LITERAL(1, 14, 17), // "memoryOverflowSig"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 12), // "startMonitor"
QT_MOC_LITERAL(4, 46, 11) // "stopMonitor"

    },
    "MemoryMonitor\0memoryOverflowSig\0\0"
    "startMonitor\0stopMonitor"
};
...
void MemoryMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MemoryMonitor *_t = static_cast<MemoryMonitor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->memoryOverflowSig(); break;
        case 1: _t->startMonitor(); break;
        case 2: _t->stopMonitor(); break;
        default: ;
        }
        ...
        {
            typedef void (MemoryMonitor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MemoryMonitor::memoryOverflowSig)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MemoryMonitor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MemoryMonitor.data,
      qt_meta_data_MemoryMonitor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MemoryMonitor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MemoryMonitor.stringdata0))
        return static_cast<void*>(const_cast< MemoryMonitor*>(this));
...
// SIGNAL 0
void MemoryMonitor::memoryOverflowSig()
{
